...
if (isset($_POST['update'])) {
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($pesan_kesalahan)) {
      ...
      $result = mysqli_query(
        $connection,
        "UPDATE ketidakhadiran SET keterangan='$keterangan', deskripsi='$deskripsi', tanggal='$tanggal', file='$nama_file' WHERE id = $id"
      );
      ...
      <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <textarea name="deskripsi" class="form-control" cols="50" rows="5">
              <?= $deskripsi; ?>
            </textarea>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control" name="file_baru" id="">
